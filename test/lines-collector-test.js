...
describe('LinesCollector', () => {
  ...
  it('collects land lines', async () => {
    ...
    assert.strictEqual(result.length, 3)
    assert.strictEqual(result[0], '新宿区 552,200,0001,036.32 14.12.17')
    assert.strictEqual(result[1], '静岡県小山町 31,324,5515,138 昭和58. 1.15')
    assert.strictEqual(result[2], '新宿区 543,600,0001,003.87 14.12.17')
  })
})
